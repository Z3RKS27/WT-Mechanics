                            ...
                            <div>
                                <Card className="shadow-none border-0 bg-transparent">
                                    <CardContent className="flex flex-col justify-center p-2 items-center text-center">
                                        <p className="text-lg sm:text-2xl font-semibold text-wrap dark:text-secondary">{title}</p>
                                        <p className="text-sm sm:text-xl text-wrap dark:text-secondary">{descripcion}</p>
                                    </CardContent>
